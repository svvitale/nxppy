...
nxppy = Extension('nxppy',
                  ...
                  extra_compile_args=['-O0',
                                      '-std=gnu99',
                                      '-isystem{}/NxpNfcRdLib/intfs'.format(nxprdlib_include_path),
                                      '-isystem{}/NxpNfcRdLib/types'.format(nxprdlib_include_path),
                                      '-isystem{}/NxpNfcRdLib/comps/phbalReg/src/LinuxUserSpi'.format(nxprdlib_include_path),
                                      #'-isystem{}/linux/shared'.format(nxprdlib_include_path),
                                      '-isystem{}/NfcrdlibEx4_MIFAREClassic/intfs'.format(nxprdlib_include_path),
                                      #'-isystem{}/NxpNfcRdLib/comps/phbalReg/src/Stub'.format(nxprdlib_include_path),
